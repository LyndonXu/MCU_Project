...
u16 SysTimeDiffWord( u16 u16Begin, u16 u16End)
{
	if (u16End >= u16Begin)
	{
		return (u16End - u16Begin);
	}
	else
	{
		return ((u16)(~0)) - u16Begin + u16End;
	}
}
...
void Delayus(u16 u16Timeus)
{
	u16 u16Begin = TIM2->CNT;
	
	while(SysTimeDiffWord(u16Begin, TIM2->CNT) < u16Timeus);	
}
